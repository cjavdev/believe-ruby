...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/believe/helpers/` and `examples/` directory.
...
```ruby
gem "believe", git: "https://github.com/stainless-sdks/believe-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://github.com/stainless-sdks/believe-ruby' '<path-to-repo>'
```

```ruby
gem "believe", path: "<path-to-repo>"
```
