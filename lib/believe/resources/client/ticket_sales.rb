  ...
  module Resources
    class Client
      ...
      class TicketSales
        ...
        #
        # @param purchase_method [Symbol, Believe::Models::Client::TicketSaleCreateParams::PurchaseMethod] How the ticket was purchased
        #
        ...
        #
        # @return [Believe::Models::Client::TicketSaleCreateResponse]
        #
        # @see Believe::Models::Client::TicketSaleCreateParams
        def create(params)
          parsed, options = Believe::Models::Client::TicketSaleCreateParams.dump_request(params)
          @client.request(
            method: :post,
            path: "ticket-sales",
            body: parsed,
            model: Believe::Models::Client::TicketSaleCreateResponse,
            options: options
          )
        end
        ...
        # @param request_options [Believe::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Believe::Models::Client::TicketSaleRetrieveResponse]
        #
        # @see Believe::Models::Client::TicketSaleRetrieveParams
        def retrieve(ticket_sale_id, params = {})
          @client.request(
            method: :get,
            path: ["ticket-sales/%1$s", ticket_sale_id],
            model: Believe::Models::Client::TicketSaleRetrieveResponse,
        ...
        # @param request_options [Believe::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Believe::Models::Client::TicketSaleUpdateResponse]
        #
        # @see Believe::Models::Client::TicketSaleUpdateParams
        def update(ticket_sale_id, params = {})
          parsed, options = Believe::Models::Client::TicketSaleUpdateParams.dump_request(params)
          @client.request(
            method: :patch,
            path: ["ticket-sales/%1$s", ticket_sale_id],
            body: parsed,
            model: Believe::Models::Client::TicketSaleUpdateResponse,
            options: options
          )
        end
        ...
        # @param request_options [Believe::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Believe::Internal::SkipLimitPage<Believe::Models::Client::TicketSaleListResponse>]
        #
        # @see Believe::Models::Client::TicketSaleListParams
        def list(params = {})
          parsed, options = Believe::Models::Client::TicketSaleListParams.dump_request(params)
          ...
          @client.request(
            ...
            model: Believe::Models::Client::TicketSaleListResponse,
            options: options
          )
        end
        ...
        # @return [nil]
        #
        # @see Believe::Models::Client::TicketSaleDeleteParams
