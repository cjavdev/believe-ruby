...
module Believe
  module Models
    ...
    class Match < Believe::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, away_team_id:, date:, home_team_id:, match_type:, attendance: nil, away_score: nil, episode_id: nil, home_score: nil, lesson_learned: nil, possession_percentage: nil, result: nil, ted_halftime_speech: nil, ticket_revenue_gbp: nil, turning_points: nil, weather_temp_celsius: nil)
