...
module Believe
  module Models
    ...
    class EpisodeCreateParams < ::Believe::Internal::Type::BaseModel
      ...
      # @!method initialize(air_date:, character_focus:, director:, episode_number:, main_theme:, runtime_minutes:, season:, synopsis:, ted_wisdom:, title:, writer:, biscuits_with_boss_moment: nil, memorable_moments: nil, us_viewers_millions: nil, viewer_rating: nil, request_options: {})
