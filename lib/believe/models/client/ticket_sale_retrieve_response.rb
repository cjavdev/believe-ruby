...
module Believe
  module Models
    module Client
      # @see Believe::Resources::Client::TicketSales#retrieve
      class TicketSaleRetrieveResponse < Believe::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Believe::Models::Client::TicketSaleRetrieveResponse::PurchaseMethod]
        required :purchase_method,
                 enum: -> { Believe::Models::Client::TicketSaleRetrieveResponse::PurchaseMethod }
        ...
        #
        #   @param purchase_method [Symbol, Believe::Models::Client::TicketSaleRetrieveResponse::PurchaseMethod] How the ticket was purchased
        #
        ...
        # How the ticket was purchased
        #
        # @see Believe::Models::Client::TicketSaleRetrieveResponse#purchase_method
