...
module Believe
  module Models
    module Client
      ...
      class TicketSaleCreateResponse < Believe::Internal::Type::BaseModel
        # @!attribute id
        #   Unique identifier
        #
        #   @return [String]
        ...
        #
        #   @return [Symbol, Believe::Models::Client::TicketSaleCreateResponse::PurchaseMethod]
        required :purchase_method, enum: -> { Believe::Models::Client::TicketSaleCreateResponse::PurchaseMethod }
        ...
        #
        #   @param purchase_method [Symbol, Believe::Models::Client::TicketSaleCreateResponse::PurchaseMethod] How the ticket was purchased
        #
        ...
        # How the ticket was purchased
        #
        # @see Believe::Models::Client::TicketSaleCreateResponse#purchase_method
