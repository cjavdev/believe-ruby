...
module Believe
  module Models
    module Client
      ...
      class TicketSaleListResponse < Believe::Internal::Type::BaseModel
        # @!attribute id
        #   Unique identifier
        #
        #   @return [String]
        ...
        #
        #   @return [Symbol, Believe::Models::Client::TicketSaleListResponse::PurchaseMethod]
        required :purchase_method, enum: -> { Believe::Models::Client::TicketSaleListResponse::PurchaseMethod }
        ...
        #
        #   @param purchase_method [Symbol, Believe::Models::Client::TicketSaleListResponse::PurchaseMethod] How the ticket was purchased
        #
        ...
        # How the ticket was purchased
        #
        # @see Believe::Models::Client::TicketSaleListResponse#purchase_method
