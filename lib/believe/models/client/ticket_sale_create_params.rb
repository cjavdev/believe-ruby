...
module Believe
  module Models
    module Client
      # @see Believe::Resources::Client::TicketSales#create
      class TicketSaleCreateParams < Believe::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Believe::Models::Client::TicketSaleCreateParams::PurchaseMethod]
        required :purchase_method, enum: -> { Believe::Models::Client::TicketSaleCreateParams::PurchaseMethod }
        ...
        # @!method initialize(buyer_name:, currency:, discount:, match_id:, purchase_method:, quantity:, subtotal:, tax:, total:, unit_price:, buyer_email: nil, coupon_code: nil, request_options: {})
