...
module Believe
  module Models
    ...
    class TeamCreateParams < ::Believe::Internal::Type::BaseModel
      ...
      optional :annual_budget_gbp, union: -> { ::Believe::TeamCreateParams::AnnualBudgetGbp }, nil?: true
      ...
      # @!method initialize(culture_score:, founded_year:, league:, name:, stadium:, values:, annual_budget_gbp: nil, average_attendance: nil, contact_email: nil, is_active: nil, nickname: nil, primary_color: nil, rival_teams: nil, secondary_color: nil, stadium_location: nil, website: nil, win_percentage: nil, request_options: {})
