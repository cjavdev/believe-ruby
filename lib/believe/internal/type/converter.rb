    ...
    module Type
      ...
      module Converter
        ...
        class << self
          ...
          # @param value [Object]
          #
          # @param state [Hash{Symbol=>Object}] The `strictness` is one of `true`, `false`. This informs the coercion strategy when we have to decide between multiple possible conversion targets:
          #   - `true`:  the conversion must be exact, with minimum coercion.
          #   - `false`: the conversion can be approximate, with some coercion.
          #
          # The `exactness` is `Hash` with keys being one of `yes`, `no`, or `maybe`.
          # For any given conversion attempt, the exactness will be updated based on how closely the value recursively matches the target type:
