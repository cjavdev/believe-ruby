...
module Believe
  module Internal
    module Type
      ...
      # @example
      #   case team_member_create_response
      #   in {member_type: :player, id: id, character_id: character_id, jersey_number: jersey_number}
      #     puts(id)
      #   in {member_type: :coach, id: id, character_id: character_id, specialty: specialty}
      #     puts(character_id)
      #   in {member_type: :medical_staff, id: id, character_id: character_id, specialty: specialty}
      #     puts(specialty)
      #   else
      #     puts(team_member_create_response)
      #   end
