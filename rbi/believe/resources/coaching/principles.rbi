  ...
  module Resources
    class Coaching
      ...
      class Principles
        ...
        sig do
          params(principle_id: String, request_options: ::Believe::RequestOptions::OrHash)
            .returns(::Believe::Coaching::CoachingPrinciple)
        end
        def retrieve(principle_id, request_options: {}); end
        ...
        sig do
          params(limit: Integer, skip: Integer, request_options: ::Believe::RequestOptions::OrHash)
            .returns(::Believe::Internal::SkipLimitPage[::Believe::Coaching::CoachingPrinciple])
        end
        def list(
        ...
        sig { params(request_options: ::Believe::RequestOptions::OrHash).returns(::Believe::Coaching::CoachingPrinciple) }
        def get_random(request_options: {}); end
