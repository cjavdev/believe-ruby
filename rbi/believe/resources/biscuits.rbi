...
module Believe
  module Resources
    ...
    class Biscuits
      ...
      sig { params(biscuit_id: String, request_options: ::Believe::RequestOptions::OrHash).returns(::Believe::Biscuit) }
      def retrieve(biscuit_id, request_options: {}); end
      ...
      sig { params(request_options: ::Believe::RequestOptions::OrHash).returns(::Believe::Biscuit) }
      def get_fresh(request_options: {}); end
