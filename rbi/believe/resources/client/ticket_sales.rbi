      ...
      class TicketSales
        ...
        sig do
          params(
            ...
            match_id: String,
            purchase_method:
              Believe::Models::Client::TicketSaleCreateParams::PurchaseMethod::OrSymbol,
            quantity: Integer,
            subtotal: String,
            tax: String,
            total: String,
          ...
          ).returns(Believe::Models::Client::TicketSaleCreateResponse)
        end
        def create(
        ...
        sig do
          params(
            ...
            request_options: Believe::RequestOptions::OrHash
          ).returns(Believe::Models::Client::TicketSaleRetrieveResponse)
        end
        ...
        sig do
          params(
            ...
            request_options: Believe::RequestOptions::OrHash
          ).returns(Believe::Models::Client::TicketSaleUpdateResponse)
        end
        def update(
          ticket_sale_id,
          buyer_email: nil,
