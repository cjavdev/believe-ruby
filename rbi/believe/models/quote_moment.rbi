...
module Believe
  module Models
    ...
    module QuoteMoment
      ...
      HALFTIME_SPEECH = T.let(:halftime_speech, ::Believe::QuoteMoment::TaggedSymbol)
      PRESS_CONFERENCE = T.let(:press_conference, ::Believe::QuoteMoment::TaggedSymbol)
      LOCKER_ROOM = T.let(:locker_room, ::Believe::QuoteMoment::TaggedSymbol)
      TRAINING = T.let(:training, ::Believe::QuoteMoment::TaggedSymbol)
      BISCUITS_WITH_BOSS = T.let(:biscuits_with_boss, ::Believe::QuoteMoment::TaggedSymbol)
