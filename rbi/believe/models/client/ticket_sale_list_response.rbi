    ...
    module Client
      class TicketSaleListResponse < Believe::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Believe::Models::Client::TicketSaleListResponse,
        ...
        sig do
          returns(
            Believe::Models::Client::TicketSaleListResponse::PurchaseMethod::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            match_id: String,
            purchase_method:
              Believe::Models::Client::TicketSaleListResponse::PurchaseMethod::OrSymbol,
            quantity: Integer,
            subtotal: String,
            tax: String,
            total: String,
        ...
        module PurchaseMethod
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Believe::Models::Client::TicketSaleListResponse::PurchaseMethod
              )
            end
