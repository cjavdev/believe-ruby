    ...
    module Client
      class TicketSaleUpdateResponse < Believe::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Believe::Models::Client::TicketSaleUpdateResponse,
        ...
        sig do
          returns(
            Believe::Models::Client::TicketSaleUpdateResponse::PurchaseMethod::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            match_id: String,
            purchase_method:
              Believe::Models::Client::TicketSaleUpdateResponse::PurchaseMethod::OrSymbol,
            quantity: Integer,
            subtotal: String,
            tax: String,
            total: String,
        ...
        module PurchaseMethod
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Believe::Models::Client::TicketSaleUpdateResponse::PurchaseMethod
              )
            end
