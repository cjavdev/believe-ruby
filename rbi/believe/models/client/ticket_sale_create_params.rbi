    ...
    module Client
      class TicketSaleCreateParams < Believe::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Believe::Models::Client::TicketSaleCreateParams,
        ...
        module PurchaseMethod
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Believe::Models::Client::TicketSaleCreateParams::PurchaseMethod
              )
            end
          ...
          ONLINE =
            T.let(
              :online,
              Believe::Models::Client::TicketSaleCreateParams::PurchaseMethod::TaggedSymbol
            )
          BOX_OFFICE =
            T.let(
              :box_office,
