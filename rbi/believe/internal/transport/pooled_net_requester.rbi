  ...
  module Internal
    module Transport
      ...
      class PooledNetRequester
        ...
        # @api private
        sig do
          params(request: ::Believe::Internal::Transport::PooledNetRequester::Request)
        ...
        def self.new(size: ::Believe::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS); end
      end
    end
  end
end
