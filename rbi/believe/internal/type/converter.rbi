  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input = T.type_alias { T.any(::Believe::Internal::Type::Converter, T::Class[T.anything]) }
        ...
        sig do
          overridable
            .params(value: T.anything, state: ::Believe::Internal::Type::Converter::CoerceState)
            .returns(T.anything)
        end
        ...
        sig do
          overridable
            .params(value: T.anything, state: ::Believe::Internal::Type::Converter::DumpState)
            .returns(T.anything)
        end
        ...
        class << self
          ...
          def self.meta_info(type_info, spec); end

          # @api private
          sig { params(translate_names: T::Boolean).returns(::Believe::Internal::Type::Converter::CoerceState) }
          def self.new_coerce_state(translate_names: true); end
