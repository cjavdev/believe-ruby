  ...
  module Internal
    module Type
      ...
      module Enum
        ...
        sig do
          override
            .params(value: T.any(String, Symbol, T.anything), state: ::Believe::Internal::Type::Converter::CoerceState)
        ...
        sig do
          override
            .params(value: T.any(Symbol, T.anything), state: ::Believe::Internal::Type::Converter::DumpState)
            .returns(T.any(Symbol, T.anything))
        end
