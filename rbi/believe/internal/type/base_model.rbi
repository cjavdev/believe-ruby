  ...
  module Internal
    module Type
      class BaseModel
        ...
        KnownField = T.type_alias { {mode: T.nilable(Symbol), required: T::Boolean, nilable: T::Boolean} }

        OrHash = T.type_alias { T.any(::Believe::Internal::Type::BaseModel, ::Believe::Internal::AnyHash) }
        ...
        class << self
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(::Believe::Internal::Type::BaseModel::KnownField, {type_fn: T.proc.returns(::Believe::Internal::Type::Converter::Input)})
              ]
            )
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(::Believe::Internal::Type::BaseModel::KnownField, {type: ::Believe::Internal::Type::Converter::Input})
              ]
            )
          end
          def fields; end
              ...
              type_info: T.any(
                {
                  ...
                  enum: T.nilable(T.proc.returns(::Believe::Internal::Type::Converter::Input)),
                  union: T.nilable(T.proc.returns(::Believe::Internal::Type::Converter::Input)),
                  api_name: Symbol,
                  "nil?": T::Boolean
                },
        ...
        class << self
          ...
          sig do
            override
              .params(
                value: T.any(::Believe::Internal::Type::BaseModel, T::Hash[T.anything, T.anything], T.anything),
          ...
          sig do
            override
              .params(value: T.any(T.attached_class, T.anything), state: ::Believe::Internal::Type::Converter::DumpState)
        ...
        class << self
          # @api private
          sig do
            params(model: ::Believe::Internal::Type::BaseModel, convert: T::Boolean)
        ...
        sig { params(keys: T.nilable(T::Array[Symbol])).returns(::Believe::Internal::AnyHash) }
        ...
        sig do
          params(data: T.any(T::Hash[Symbol, T.anything], ::Believe::Internal::Type::BaseModel))
