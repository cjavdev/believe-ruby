  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(::Believe::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick: T.nilable(
              T.any(
                Symbol,
                Integer,
      ...
      class << self
        # @api private
        sig { params(url: T.any(URI::Generic, String)).returns(::Believe::Internal::Util::ParsedUri) }
        def parse_uri(url); end

        # @api private
        sig { params(parsed: ::Believe::Internal::Util::ParsedUri).returns(URI::Generic) }
        def unparse_uri(parsed); end

        # @api private
        sig do
          params(lhs: ::Believe::Internal::Util::ParsedUri, rhs: ::Believe::Internal::Util::ParsedUri)
            .returns(URI::Generic)
        end
      ...
      class << self
        # @api private
        sig { params(query: ::Believe::Internal::AnyHash).returns(::Believe::Internal::AnyHash) }
        def encode_query_params(query); end

        # @api private
        sig { params(collection: ::Believe::Internal::AnyHash, key: String, element: T.anything).void }
        private def write_query_param_element!(collection, key, element); end
        ...
        sig do
          params(headers: T::Hash[String, String], stream: T::Enumerable[String], suppress_error: T::Boolean)
            .returns(T.anything)
        end
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(T::Enumerable[::Believe::Internal::Util::ServerSentEvent]) }
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          sig { params(type: T.any(::Believe::Internal::Util::SorbetRuntimeSupport, T.anything)).returns(T.anything) }
